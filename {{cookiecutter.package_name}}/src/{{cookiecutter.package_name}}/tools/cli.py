...
def make_specs(template: str, location: str, output_dir: str, verbose: int, with_debugger: bool) -> None:
    ...
    ``vivarium_gates_bep/src/vivarium_gates_bep/model_specification/model_spec.in``
    ...
    ``vivarium_gates_bep/src/vivarium_gates_bep/model_specification/locations.txt``
