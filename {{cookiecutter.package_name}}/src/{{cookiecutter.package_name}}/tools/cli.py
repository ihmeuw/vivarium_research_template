...
def make_specs(template: str, locations_file: str, single_location: str, output_dir: str) -> None:
    ...
    in the empty 'locations.txt' file. The location file is in the same
    directory as the model specification file. It should contain a single
    location per line and locations must be formatted so that they match
    location names in GBD location set X.
